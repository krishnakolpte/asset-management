        ...
        .once("value", function (snapshot) {
            ...
            snapshot.forEach(function (childSnapshot) {
                ...
                if (allocated == "false") {
                    document.getElementById(
                        "employeid"
                    ).innerHTML += `<option value="${empId}">${empId}</option>`;
                    document.getElementById(
                        "allocateAssetBtn"
                    ).disabled = false;
                    document.getElementById("allocateAssetBtn").style.cursor =
                        "pointer";
                }
            });
        });
            ...
            snapshot.forEach(function (childSnapshot) {
                ...
                if (dbid == email) {
                    ...
                    document.getElementById("empid").innerHTML =
                        "employee id : " + empId;
                    document.getElementById("calimedetailsBtn").style.display =
                        "none";
    ...
    firebase
        ...
        .once("value", function (snapshot) {
            ...
            snapshot.forEach(function (childSnapshot) {
                ...
                const formattedTodayDate = currentDate
                    .toISOString()
                    .split("T")[0];
                ...
                if (dbid == empId) {
                    ...
                    if (allocatedData.claimed == "true") {
                        ...
                        document.getElementById("calimedataBtn").style.display =
                            "none";
                    }

                    //set allocated details in allocated information modal
                    document.getElementById("asset_empid").value =
                        allocatedData.employeId;
                    document.getElementById("asset_id").value =
                        allocatedData.assetId;
                    document.getElementById("asset_type").value =
                        allocatedData.assetType;
                    document.getElementById("asset_permis").value =
                        allocatedData.assetPermission;
                    document.getElementById("asset_allocated_date").value =
                        allocatedData.allocationDate;
                    document.getElementById("asset_all_expire_date").value =
                        allocatedData.allocationExpireDate;
                    document.getElementById("asset_all_by").value =
                        allocatedData.allocatedBy;
